...
description: All parent threads (any model, any effort level) cap parallel background-agent spawns at 2 Opus / 4 Sonnet / 6 Haiku at once; sequence rounds if more agents are needed
type: feedback
originSessionId: 5bbbce8a-f733-4014-ad8f-1544228ee698
user: krystal
---
**All parent threads** — regardless of model (Opus, Sonnet, Haiku) or effort level — cap parallel **background-agent** spawns at:

- **2 Opus background agents at once**
- **4 Sonnet background agents at once**
- **6 Haiku background agents at once**
...
- The cap is *per model* and *concurrent*: count active background agents at the moment of spawn; a new spawn is allowed if it does not push the count above-cap for its model tier.
